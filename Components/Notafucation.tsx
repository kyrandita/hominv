...
export default dynamic(() => import('nota-fucation').then(nota => {
    return function NotaFucation() {
        useEffect(() => {
    ...
    `);
                nota.notafucation.registerComponent()
                nota.notatoast.registerComponent()
                nota.notatoast.NotaToast.addStyleSheet(backuptoastsheet)
            }
        }, [])
